...
def plot_data_and_line(image, data_points, line_width=1.0):
    ...
    plt.legend()
    plt.show()
    # plt.savefig('D:/PythonProject/lanenet-lane-detection-pytorch-main/test_output/instance_image/288.png', format='png', dpi=300, bbox_inches='tight')
    # 设置坐标轴不可见
    # plt.axis('off')
    #
    # # plt.legend()
    # plt.savefig('D:/PythonProject/lanenet-lane-detection-pytorch-main/test_output/instance_image/288.png', format='png', dpi=400, bbox_inches='tight')
    # # plt.show()
...
def fit_lines_hough(data_points_old, idx):
    ...
    image = IMG.copy()
    plot_data_and_line(image, data_points_new, line_width=2.0)


def draw_lines(instance_result, labels):
...
# 示例调用
binary_image_path = 'E:/A_trans/results/AH/3/Unet/283_binary_output.png'
instance_image_path = 'E:/A_trans/results/AH/3/Unet/283_instance_output.png'
RGB_IMG = cv2.imread("E:/A_trans/results/AH/3/Unet/283_input.png")
...
draw_lines(instance_out, labels)
