...
from src.trainer.tester import Test
...
if __name__ == '__main__':
    ...
    args.add_argument('-c', '--config', default="/Users/gengyuhang/PycharmProjects/pythonProject5/src/models/CVF_SID/SIDD_Val/config.json", type=str,
                      help='config file path (default: None)')
    args.add_argument('-r', '--resume', default="/Users/gengyuhang/PycharmProjects/pythonProject5/src/models/CVF_SID/SIDD_Val/model_best.pth", type=str,
