"""
SegCropNet model post process(other test)
"""
...
class _SegCropNetCluster(object):
    """
...
class SegCropNetPostProcessor(object):
    """
    SegCropNet post process for lane generation
    """
    def __init__(self, cfg, ipm_remap_file_path='./data/corn.yml'):
        """
    ...
    def postprocess(self, binary_seg_result, instance_seg_result=None,
        ...
        for lane_index, coords in enumerate(lane_coords):
            if data_source == 'corn':
                ...
                raise ValueError('Wrong data source now only support corn')
        ...
        # corn test data sample point along y axis every 10 pixels
